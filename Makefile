...
OBJS = start.o main.o ipc.o vsprintf.o string.o gecko.o memory.o memory_asm.o \
	utils_asm.o utils.o ff.o ffsystem.o diskio.o sdhc.o \
	powerpc_elf.o powerpc.o panic.o irq.o irq_asm.o exception.o \
	exception_asm.o seeprom.o crypto.o nand.o boot2.o ldhack.o sdmmc.o
